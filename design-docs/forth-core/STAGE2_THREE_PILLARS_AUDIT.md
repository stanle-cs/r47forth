...
instruction). Baselines read in full: `design-docs/forth-core/DESIGN.md`
(2147 lines, authoritative), `design-docs/package-manager/README.md`, `BUILD.md`.
...
(`design-docs/package-manager/README.md`, Authoring Workflow).
