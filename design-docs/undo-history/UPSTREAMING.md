...
1. `src/c47/meson.build`: add `'undoHistory.c'` (and U2:
...
3. Wiki/manual: REDO and HCLR item descriptions (catalog-reachable,
   user-assignable; menu_STK placement is a U2 decision). The menu-number
