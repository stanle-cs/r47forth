...
// distinctQuotes == 0 preserves the legacy mapping `"` -> `'` (used by
// --dumpMenus1/2). distinctQuotes == 1 maps `"` -> `''` so MNU_1STDERIV
// ("f'") and MNU_2NDDERIV ("f\"") yield distinct filenames `f'` and
// `f''` under --dumpMenusAll (RefDB47 superset).
