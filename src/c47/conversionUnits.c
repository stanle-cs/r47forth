...
TO_QSPI const fInMim_t MimFunctionsType3Conv[NUM_CONVERT_PAIRS] =
  {   //conversion
    ...
    {ITM_KGtoBLOB    },
    {ITM_TONNEtoKG   },
    {ITM_KGtoTONNE   }, // do mimRunFunction(item, indexOfItems[item].param);
   };
...
TO_QSPI static const convPair_t convertPairs[NUM_CONVERT_PAIRS] = {              // sorted by item
  ...
  { ITM_CtoF                     , ITM_FtoC             , ITM_FtoK           , +0 , UT_TEMPERATURE              },
  { ITM_FtoC             , ITM_CtoF             , ITM_CtoK           , +0 , UT_TEMPERATURE              },
  { ITM_DBtoPR           , ITM_PRtoDB           , ITM_NULL           , +0 , UT_NOT_CONFIGURABLE         },
  { ITM_FT2toHA          , ITM_HAtoFT2          , ITM_NULL           , +4 , UT_AREA                     },
  { ITM_HAtoFT2          , ITM_FT2toHA          , ITM_FT2toM2        , +0 , UT_AREA                     },
  { ITM_DBtoFR           , ITM_FRtoDB           , ITM_NULL           , +0 , UT_NOT_CONFIGURABLE         },
  { ITM_FT2toM2          , ITM_M2toFT2          , ITM_NULL           , +0 , UT_AREA                     },
  { ITM_M2toFT2          , ITM_FT2toM2          , ITM_FT2toM2        , +0 , UT_AREA                     },
  { ITM_PRtoDB           , ITM_DBtoPR           , ITM_NULL           , +0 , UT_NOT_CONFIGURABLE         },
  { ITM_HAtoKM2          , ITM_KM2toHA          , ITM_NULL           , +6 , UT_AREA                     },
  { ITM_KM2toHA          , ITM_HAtoKM2          , ITM_NULL           , +4 , UT_AREA                     },
  { ITM_FRtoDB           , ITM_DBtoFR           , ITM_NULL           , +0 , UT_NOT_CONFIGURABLE         },
  { ITM_GLUKtoFZUK       , ITM_FZUKtoGLUK       , ITM_FZUKtoML       , -3 , UT_VOLUME                   },
  { ITM_FZUKtoGLUK       , ITM_GLUKtoFZUK       , ITM_GLUKtoL        , +0 , UT_VOLUME                   },
  { ITM_ACtoHA           , ITM_HAtoAC           , ITM_NULL           , +4 , UT_AREA                     },
  { ITM_MLtoIN3          , ITM_IN3toML          , ITM_IN3toML        , -3 , UT_VOLUME                   },
  { ITM_HAtoAC           , ITM_ACtoHA           , ITM_ACtoHA         , +4 , UT_AREA                     },
  { ITM_IN3toML          , ITM_MLtoIN3          , ITM_NULL           , -3 , UT_VOLUME                   },
  { ITM_ACUStoHA         , ITM_HAtoACUS         , ITM_NULL           , +4 , UT_AREA                     },
  { ITM_FT3toGLUK        , ITM_GLUKtoFT3        , ITM_GLUKtoL        , +0 , UT_VOLUME                   },
  { ITM_HAtoACUS         , ITM_ACUStoHA         , ITM_ACUStoHA       , +4 , UT_AREA                     },
  { ITM_GLUKtoFT3        , ITM_FT3toGLUK        , ITM_FT3toL         , +0 , UT_VOLUME                   },
  { ITM_PAtoATM          , ITM_ATMtoPA          , ITM_ATMtoPA        , +0 , UT_PRESSURE                 },
  { ITM_ATMtoPA          , ITM_PAtoATM          , ITM_NULL           , +0 , UT_PRESSURE                 },
  { ITM_AUtoM            , ITM_MtoAU            , ITM_NULL           , +0 , UT_DISTANCE                 },
  { ITM_MtoAU            , ITM_AUtoM            , ITM_AUtoM          , +0 , UT_DISTANCE                 },
  { ITM_BARtoPA          , ITM_PAtoBAR          , ITM_NULL           , +0 , UT_PRESSURE                 },
  { ITM_PAtoBAR          , ITM_BARtoPA          , ITM_BARtoPA        , +0 , UT_PRESSURE                 },
  { ITM_BTUtoJ           , ITM_JtoBTU           , ITM_NULL           , +0 , UT_ENERGY                   },
  { ITM_JtoBTU           , ITM_BTUtoJ           , ITM_BTUtoJ         , +0 , UT_ENERGY                   },
  { ITM_CALtoJ           , ITM_JtoCAL           , ITM_NULL           , +0 , UT_ENERGY                   },
  { ITM_JtoCAL           , ITM_CALtoJ           , ITM_CALtoJ         , +0 , UT_ENERGY                   },
  { ITM_LBFFTtoNM        , ITM_NMtoLBFFT        , ITM_NULL           , +0 , UT_TORQUE                   },
  { ITM_LtoFT3           , ITM_FT3toL           , ITM_FT3toL         , +0 , UT_VOLUME                   },
  { ITM_NMtoLBFFT        , ITM_LBFFTtoNM        , ITM_LBFFTtoNM      , +0 , UT_TORQUE                   },
  { ITM_FT3toL           , ITM_LtoFT3           , ITM_NULL           , +0 , UT_VOLUME                   },
  { ITM_CWTtoKG          , ITM_KGtoCWT          , ITM_NULL           , +0 , UT_MASS                     },
  { ITM_KGtoCWT          , ITM_CWTtoKG          , ITM_CWTtoKG        , +0 , UT_MASS                     },
  { ITM_FTtoM            , ITM_MtoFT            , ITM_NULL           , +0 , UT_DISTANCE                 },
  { ITM_MtoFT            , ITM_FTtoM            , ITM_FTtoM          , +0 , UT_DISTANCE                 },
  { ITM_FTUStoM          , ITM_MtoFTUS          , ITM_NULL           , +0 , UT_DISTANCE                 },
  { ITM_LtoQTUS          , ITM_QTUStoL          , ITM_QTUStoL        , +0 , UT_VOLUME                   },
  { ITM_QTUStoL          , ITM_LtoQTUS          , ITM_NULL           , +0 , UT_VOLUME                   },
  { ITM_MtoFTUS          , ITM_FTUStoM          , ITM_FTUStoM        , +0 , UT_DISTANCE                 },
  { ITM_IN3toFZUK        , ITM_FZUKtoIN3        , ITM_FZUKtoML       , -3 , UT_VOLUME                   },
  { ITM_FZUKtoIN3        , ITM_IN3toFZUK        , ITM_IN3toML        , -3 , UT_VOLUME                   },
  { ITM_FZUKtoML         , ITM_MLtoFZUK         , ITM_NULL           , -3 , UT_VOLUME                   },
  { ITM_IN3toFZUS        , ITM_FZUStoIN3        , ITM_FZUStoML       , -3 , UT_VOLUME                   },
  { ITM_MLtoFZUK         , ITM_FZUKtoML         , ITM_FZUKtoML       , -3 , UT_VOLUME                   },
  { ITM_FZUStoIN3        , ITM_IN3toFZUS        , ITM_IN3toML        , -3 , UT_VOLUME                   },
  { ITM_FZUStoML         , ITM_MLtoFZUS         , ITM_NULL           , -3 , UT_VOLUME                   },
  { ITM_FT3toGalUS       , ITM_GalUStoFT3       , ITM_GLUStoL        , +0 , UT_VOLUME                   },
  { ITM_MLtoFZUS         , ITM_FZUStoML         , ITM_FZUStoML       , -3 , UT_VOLUME                   },
  { ITM_GalUStoFT3       , ITM_FT3toGalUS       , ITM_FT3toL         , +0 , UT_VOLUME                   },
  { ITM_GLUKtoL          , ITM_LtoGLUK          , ITM_NULL           , +0 , UT_VOLUME                   },
  { ITM_LtoGLUK          , ITM_GLUKtoL          , ITM_GLUKtoL        , +0 , UT_VOLUME                   },
  { ITM_GLUStoL          , ITM_LtoGLUS          , ITM_NULL           , +0 , UT_VOLUME                   },
  { ITM_LtoGLUS          , ITM_GLUStoL          , ITM_GLUStoL        , +0 , UT_VOLUME                   },
  { ITM_HPEtoW           , ITM_WtoHPE           , ITM_NULL           , +0 , UT_POWER                    },
  { ITM_WtoHPE           , ITM_HPEtoW           , ITM_HPEtoW         , +0 , UT_POWER                    },
  { ITM_HPMtoW           , ITM_WtoHPM           , ITM_NULL           , +0 , UT_POWER                    },
  { ITM_WtoHPM           , ITM_HPMtoW           , ITM_HPMtoW         , +0 , UT_POWER                    },
  { ITM_HPUKtoW          , ITM_WtoHPUK          , ITM_NULL           , +0 , UT_POWER                    },
  { ITM_WtoHPUK          , ITM_HPUKtoW          , ITM_HPUKtoW        , +0 , UT_POWER                    },
  { ITM_INCHHGtoPA       , ITM_PAtoINCHHG       , ITM_NULL           , +0 , UT_PRESSURE                 },
  { ITM_CUPCtoFZUS       , ITM_FZUStoCUPC       , ITM_FZUStoML       , -3 , UT_VOLUME                   },
  { ITM_PAtoINCHHG       , ITM_INCHHGtoPA       , ITM_INCHHGtoPA     , +0 , UT_PRESSURE                 },
  { ITM_CUPCtoML         , ITM_MLtoCUPC         , ITM_NULL           , -3 , UT_VOLUME                   },
  { ITM_INCHtoMM         , ITM_MMtoINCH         , ITM_NULL           , -3 , UT_DISTANCE                 },
  { ITM_MMtoINCH         , ITM_INCHtoMM         , ITM_INCHtoCM       , -2 , UT_DISTANCE                 },
  { ITM_WHtoJ            , ITM_JtoWH            , ITM_NULL           , +0 , UT_ENERGY                   },
  { ITM_JtoWH            , ITM_WHtoJ            , ITM_WHtoJ          , +0 , UT_ENERGY                   },
  { ITM_KGtoLBS          , ITM_LBStoKG          , ITM_LBStoKG        , +0 , UT_MASS                     },
  { ITM_LBStoKG          , ITM_KGtoLBS          , ITM_NULL           , +0 , UT_MASS                     },
  { ITM_GtoOZ            , ITM_OZtoG            , ITM_OZtoG          , -3 , UT_MASS                     },
  { ITM_OZtoG            , ITM_GtoOZ            , ITM_NULL           , -3 , UT_MASS                     },
  { ITM_KGtoSCW          , ITM_SCWtoKG          , ITM_SCWtoKG        , +0 , UT_MASS                     },
  { ITM_CUPUKtoFZUK      , ITM_FZUKtoCUPUK      , ITM_FZUKtoML       , -3 , UT_VOLUME                   },
  { ITM_SCWtoKG          , ITM_KGtoSCW          , ITM_NULL           , +0 , UT_MASS                     },
  { ITM_CUPUKtoML        , ITM_MLtoCUPUK        , ITM_NULL           , -3 , UT_VOLUME                   },
  { ITM_KGtoSTO          , ITM_STOtoKG          , ITM_STOtoKG        , +0 , UT_MASS                     },
  { ITM_FZUKtoCUPUK      , ITM_CUPUKtoFZUK      , ITM_CUPUKtoML      , -3 , UT_VOLUME                   },
  { ITM_STOtoKG          , ITM_KGtoSTO          , ITM_NULL           , +0 , UT_MASS                     },
  { ITM_FZUKtoTBSPUK     , ITM_TBSPUKtoFZUK     , ITM_TBSPUKtoML     , -3 , UT_VOLUME                   },
  { ITM_KGtoST           , ITM_STtoKG           , ITM_STtoKG         , +0 , UT_MASS                     },
  { ITM_FZUKtoTSPUK      , ITM_TSPUKtoFZUK      , ITM_TSPUKtoML      , -3 , UT_VOLUME                   },
  { ITM_FZUStoCUPC       , ITM_CUPCtoFZUS       , ITM_CUPCtoML       , -3 , UT_VOLUME                   },
  { ITM_STtoKG           , ITM_KGtoST           , ITM_NULL           , +0 , UT_MASS                     },
  { ITM_FZUStoTBSPC      , ITM_TBSPCtoFZUS      , ITM_TBSPCtoML      , -3 , UT_VOLUME                   },
  { ITM_FZUStoTSPC       , ITM_TSPCtoFZUS       , ITM_TSPCtoML       , -3 , UT_VOLUME                   },
  { ITM_KGtoLT           , ITM_LTtoKG           , ITM_LTtoKG         , +0 , UT_MASS                     },
  { ITM_KGtoLIANG        , ITM_LIANGtoKG        , ITM_LIANGtoKG      , +0 , UT_MASS                     },
  { ITM_MLtoCUPC         , ITM_CUPCtoML         , ITM_CUPCtoML       , -3 , UT_VOLUME                   },
  { ITM_LTtoKG           , ITM_KGtoLT           , ITM_NULL           , +0 , UT_MASS                     },
  { ITM_LIANGtoKG        , ITM_KGtoLIANG        , ITM_NULL           , +0 , UT_MASS                     },
  { ITM_MLtoCUPUK        , ITM_CUPUKtoML        , ITM_CUPUKtoML      , -3 , UT_VOLUME                   },
  { ITM_GtoTRZ           , ITM_TRZtoG           , ITM_TRZtoG         , -3 , UT_MASS                     },
  { ITM_MLtoPINTLQ       , ITM_PINTLQtoML       , ITM_PINTLQtoML     , -3 , UT_VOLUME                   },
  { ITM_TRZtoG           , ITM_GtoTRZ           , ITM_NULL           , -3 , UT_MASS                     },
  { ITM_MLtoPINTUK       , ITM_PINTUKtoML       , ITM_PINTUKtoML     , -3 , UT_VOLUME                   },
  { ITM_LBFtoN           , ITM_NtoLBF           , ITM_NULL           , +0 , UT_FORCE                    },
  { ITM_NtoLBF           , ITM_LBFtoN           , ITM_LBFtoN         , +0 , UT_FORCE                    },
  { ITM_LYtoM            , ITM_MtoLY            , ITM_NULL           , +0 , UT_DISTANCE                 },
  { ITM_MtoLY            , ITM_LYtoM            , ITM_LYtoM          , +0 , UT_DISTANCE                 },
  { ITM_MMHGtoPA         , ITM_PAtoMMHG         , ITM_NULL           , +0 , UT_PRESSURE                 },
  { ITM_MLtoQT           , ITM_QTtoML           , ITM_QTtoL          , +0 , UT_VOLUME                   },
  { ITM_PAtoMMHG         , ITM_MMHGtoPA         , ITM_MMHGtoPA       , +0 , UT_PRESSURE                 },
  { ITM_MLtoQTUS         , ITM_QTUStoML         , ITM_QTUStoL        , +0 , UT_VOLUME                   },
  { ITM_MItoKM           , ITM_KMtoMI           , ITM_NULL           , +3 , UT_DISTANCE                 },
  { ITM_KMtoMI           , ITM_MItoKM           , ITM_MILEtoM        , +0 , UT_DISTANCE                 },
  { ITM_KMtoNMI          , ITM_NMItoKM          , ITM_NMItoM         , +0 , UT_DISTANCE                 },
  { ITM_NMItoKM          , ITM_KMtoNMI          , ITM_NULL           , +3 , UT_DISTANCE                 },
  { ITM_MtoPC            , ITM_PCtoM            , ITM_PCtoM          , +0 , UT_DISTANCE                 },
  { ITM_PCtoM            , ITM_MtoPC            , ITM_NULL           , +0 , UT_DISTANCE                 },
  { ITM_MMtoPOINT        , ITM_POINTtoMM        , ITM_POINTtoMM      , -3 , UT_DISTANCE                 },
  { ITM_MLtoTBSPC        , ITM_TBSPCtoML        , ITM_TBSPCtoML      , -3 , UT_VOLUME                   },
  { ITM_MILEtoM          , ITM_MtoMILE          , ITM_NULL           , +0 , UT_DISTANCE                 },
  { ITM_POINTtoMM        , ITM_MMtoPOINT        , ITM_NULL           , -3 , UT_DISTANCE                 },
  { ITM_MLtoTBSPUK       , ITM_TBSPUKtoML       , ITM_TBSPUKtoML     , -3 , UT_VOLUME                   },
  { ITM_MtoMILE          , ITM_MILEtoM          , ITM_MILEtoM        , +0 , UT_DISTANCE                 },
  { ITM_MtoYD            , ITM_YDtoM            , ITM_YDtoM          , +0 , UT_DISTANCE                 },
  { ITM_YDtoM            , ITM_MtoYD            , ITM_NULL           , +0 , UT_DISTANCE                 },
  { ITM_PSItoPA          , ITM_PAtoPSI          , ITM_NULL           , +0 , UT_PRESSURE                 },
  { ITM_PAtoPSI          , ITM_PSItoPA          , ITM_PSItoPA        , +0 , UT_PRESSURE                 },
  { ITM_PAtoTOR          , ITM_TORtoPA          , ITM_TORtoPA        , +0 , UT_PRESSURE                 },
  { ITM_MLtoTSPC         , ITM_TSPCtoML         , ITM_TSPCtoML       , -3 , UT_VOLUME                   },
  { ITM_TORtoPA          , ITM_PAtoTOR          , ITM_NULL           , +0 , UT_PRESSURE                 },
  { ITM_MLtoTSPUK        , ITM_TSPUKtoML        , ITM_TSPUKtoML      , -3 , UT_VOLUME                   },
  { ITM_StoYEAR          , ITM_YEARtoS          , ITM_YEARtoS        , +0 , UT_TIME                     },
  { ITM_YEARtoS          , ITM_StoYEAR          , ITM_NULL           , +0 , UT_TIME                     },
  { ITM_CARATtoG         , ITM_GtoCARAT         , ITM_NULL           , -3 , UT_MASS                     },
  { ITM_PINTLQtoML       , ITM_MLtoPINTLQ       , ITM_NULL           , -3 , UT_VOLUME                   },
  { ITM_JINtoKG          , ITM_KGtoJIN          , ITM_NULL           , +0 , UT_MASS                     },
  { ITM_GtoCARAT         , ITM_CARATtoG         , ITM_CARATtoG       , -3 , UT_MASS                     },
  { ITM_PINTUKtoML       , ITM_MLtoPINTUK       , ITM_NULL           , -3 , UT_VOLUME                   },
  { ITM_KGtoJIN          , ITM_JINtoKG          , ITM_JINtoKG        , +0 , UT_MASS                     },
  { ITM_QTtoL            , ITM_LtoQT            , ITM_NULL           , +0 , UT_VOLUME                   },
  { ITM_LtoQT            , ITM_QTtoL            , ITM_QTtoL          , +0 , UT_VOLUME                   },
  { ITM_FATHOMtoM        , ITM_MtoFATHOM        , ITM_NULL           , +0 , UT_DISTANCE                 },
  { ITM_QTtoML           , ITM_MLtoQT           , ITM_NULL           , -3 , UT_VOLUME                   },
  { ITM_NMItoM           , ITM_MtoNMI           , ITM_NULL           , +0 , UT_DISTANCE                 },
  { ITM_MtoFATHOM        , ITM_FATHOMtoM        , ITM_FATHOMtoM      , +0 , UT_DISTANCE                 },
  { ITM_QTUStoML         , ITM_MLtoQTUS         , ITM_NULL           , -3 , UT_VOLUME                   },
  { ITM_MtoNMI           , ITM_NMItoM           , ITM_NMItoM         , +0 , UT_DISTANCE                 },
  { ITM_BARRELtoM3       , ITM_M3toBARREL       , ITM_NULL           , +3 , UT_VOLUME                   },
  { ITM_TBSPCtoFZUS      , ITM_FZUStoTBSPC      , ITM_FZUStoML       , -3 , UT_VOLUME                   },
  { ITM_M3toBARREL       , ITM_BARRELtoM3       , ITM_BARRELtoM3     , +3 , UT_VOLUME                   },
  { ITM_HMStoHR          , ITM_HRtoHMS          , ITM_NULL           , +0 , UT_NOT_CONFIGURABLE         },
  { ITM_HRtoHMS          , ITM_HMStoHR          , ITM_NULL           , +0 , UT_NOT_CONFIGURABLE         },
  { ITM_TBSPCtoML        , ITM_MLtoTBSPC        , ITM_NULL           , -3 , UT_VOLUME                   },
  { ITM_HECTAREtoM2      , ITM_M2toHECTARE      , ITM_NULL           , +0 , UT_AREA                     },
  { ITM_M2toHECTARE      , ITM_HECTAREtoM2      , ITM_NULL           , +4 , UT_AREA                     },
  { ITM_MUtoM2           , ITM_M2toMU           , ITM_NULL           , +0 , UT_AREA                     },
  { ITM_M2toMU           , ITM_MUtoM2           , ITM_MUtoM2         , +0 , UT_AREA                     },
  { ITM_LItoM            , ITM_MtoLI            , ITM_NULL           , +0 , UT_DISTANCE                 },
  { ITM_MtoLI            , ITM_LItoM            , ITM_LItoM          , +0 , UT_DISTANCE                 },
  { ITM_CHItoM           , ITM_MtoCHI           , ITM_NULL           , +0 , UT_DISTANCE                 },
  { ITM_MtoCHI           , ITM_CHItoM           , ITM_CHItoM         , +0 , UT_DISTANCE                 },
  { ITM_YINtoM           , ITM_MtoYIN           , ITM_NULL           , +0 , UT_DISTANCE                 },
  { ITM_MtoYIN           , ITM_YINtoM           , ITM_YINtoM         , +0 , UT_DISTANCE                 },
  { ITM_CUNtoM           , ITM_MtoCUN           , ITM_NULL           , +0 , UT_DISTANCE                 },
  { ITM_MtoCUN           , ITM_CUNtoM           , ITM_CUNtoM         , +0 , UT_DISTANCE                 },
  { ITM_ZHANGtoM         , ITM_MtoZHANG         , ITM_NULL           , +0 , UT_DISTANCE                 },
  { ITM_TBSPUKtoFZUK     , ITM_FZUKtoTBSPUK     , ITM_FZUKtoML       , -3 , UT_VOLUME                   },
  { ITM_MtoZHANG         , ITM_ZHANGtoM         , ITM_ZHANGtoM       , +0 , UT_DISTANCE                 },
  { ITM_TBSPUKtoML       , ITM_MLtoTBSPUK       , ITM_NULL           , -3 , UT_VOLUME                   },
  { ITM_FENtoM           , ITM_MtoFEN           , ITM_NULL           , +0 , UT_DISTANCE                 },
  { ITM_MtoFEN           , ITM_FENtoM           , ITM_FENtoM         , +0 , UT_DISTANCE                 },
  { ITM_MI2toKM2         , ITM_KM2toMI2         , ITM_NULL           , +6 , UT_AREA                     },
  { ITM_KM2toMI2         , ITM_MI2toKM2         , ITM_MI2toKM2       , +6 , UT_AREA                     },
  { ITM_NMI2toKM2        , ITM_KM2toNMI2        , ITM_NULL           , +6 , UT_AREA                     },
  { ITM_KM2toNMI2        , ITM_NMI2toKM2        , ITM_NMI2toKM2      , +6 , UT_AREA                     },
  { ITM_TSPCtoFZUS       , ITM_FZUStoTSPC       , ITM_FZUStoML       , -3 , UT_VOLUME                   },
  { ITM_TSPCtoML         , ITM_MLtoTSPC         , ITM_NULL           , -3 , UT_VOLUME                   },
  { ITM_TSPUKtoFZUK      , ITM_FZUKtoTSPUK      , ITM_FZUKtoML       , -3 , UT_VOLUME                   },
  { ITM_TSPUKtoML        , ITM_MLtoTSPUK        , ITM_NULL           , -3 , UT_VOLUME                   },
  { ITM_GLUStoFZUS       , ITM_FZUStoGLUS       , ITM_FZUStoML       , -3 , UT_VOLUME                   },
  { ITM_FZUStoGLUS       , ITM_GLUStoFZUS       , ITM_GLUStoL        , +0 , UT_VOLUME                   },
  { ITM_KNOTtoKMH        , ITM_KMHtoKNOT        , ITM_KMHtoMPS       , +0 , UT_SPEED                    },
  { ITM_KMHtoKNOT        , ITM_KNOTtoKMH        , ITM_KNOTtoMPS      , +0 , UT_SPEED                    },
  { ITM_KMHtoMPS         , ITM_MPStoKMH         , ITM_NULL           , +0 , UT_SPEED                    },
  { ITM_MPStoKMH         , ITM_KMHtoMPS         , ITM_KMHtoMPS       , +0 , UT_SPEED                    },
  { ITM_RPMtoDEGPS       , ITM_DEGPStoRPM       , ITM_DEGPStoRADPS   , +0 , UT_ANGULAR_SPEED            },
  { ITM_DEGPStoRPM       , ITM_RPMtoDEGPS       , ITM_RPMtoRADPS     , +0 , UT_ANGULAR_SPEED            },
  { ITM_MPHtoKMH         , ITM_KMHtoMPH         , ITM_KMHtoMPS       , +0 , UT_SPEED                    },
  { ITM_KMHtoMPH         , ITM_MPHtoKMH         , ITM_MPHtoMPS       , +0 , UT_SPEED                    },
  { ITM_MPHtoMPS         , ITM_MPStoMPH         , ITM_NULL           , +0 , UT_SPEED                    },
  { ITM_MPStoMPH         , ITM_MPHtoMPS         , ITM_MPHtoMPS       , +0 , UT_SPEED                    },
  { ITM_RPMtoRADPS       , ITM_RADPStoRPM       , ITM_NULL           , +0 , UT_ANGULAR_SPEED            },
  { ITM_RADPStoRPM       , ITM_RPMtoRADPS       , ITM_RPMtoRADPS     , +0 , UT_ANGULAR_SPEED            },
  { ITM_DEGtoRAD         , ITM_RADtoDEG         , ITM_NULL           , +0 , UT_ANGLE                    },
  { ITM_RADtoDEG         , ITM_DEGtoRAD         , ITM_DEGtoRAD       , +0 , UT_ANGLE                    },
  { ITM_DEGtoGRAD        , ITM_GRADtoDEG        , ITM_GRADtoRAD      , +0 , UT_ANGLE                    },
  { ITM_GRADtoDEG        , ITM_DEGtoGRAD        , ITM_DEGtoRAD       , +0 , UT_ANGLE                    },
  { ITM_GRADtoRAD        , ITM_RADtoGRAD        , ITM_NULL           , +0 , UT_ANGLE                    },
  { ITM_RADtoGRAD        , ITM_GRADtoRAD        , ITM_GRADtoRAD      , +0 , UT_ANGLE                    },
  { ITM_INCHtoCM         , ITM_CMtoINCH         , ITM_NULL           , -2 , UT_DISTANCE                 },
  { ITM_CMtoINCH         , ITM_INCHtoCM         , ITM_INCHtoCM       , -2 , UT_DISTANCE                 },
  { ITM_NMItoMI          , ITM_MItoNMI          , ITM_MILEtoM        , +0 , UT_DISTANCE                 },
  { ITM_MItoNMI          , ITM_NMItoMI          , ITM_NMItoM         , +0 , UT_DISTANCE                 },
  { ITM_FURtoM           , ITM_MtoFUR           , ITM_NULL           , +0 , UT_DISTANCE                 },
  { ITM_MtoFUR           , ITM_FURtoM           , ITM_FURtoM         , +0 , UT_DISTANCE                 },
  { ITM_FTNtoS           , ITM_StoFTN           , ITM_NULL           , +0 , UT_TIME                     },
  { ITM_StoFTN           , ITM_FTNtoS           , ITM_FTNtoS         , +0 , UT_TIME                     },
  { ITM_FPFtoMPS         , ITM_MPStoFPF         , ITM_NULL           , +0 , UT_SPEED                    },
  { ITM_MPStoFPF         , ITM_FPFtoMPS         , ITM_FPFtoMPS       , +0 , UT_SPEED                    },
  { ITM_BRDStoM          , ITM_MtoBRDS          , ITM_NULL           , +0 , UT_DISTANCE                 },
  { ITM_MtoBRDS          , ITM_BRDStoM          , ITM_BRDStoM        , +0 , UT_DISTANCE                 },
  { ITM_FIRtoKG          , ITM_KGtoFIR          , ITM_NULL           , +0 , UT_MASS                     },
  { ITM_KGtoFIR          , ITM_FIRtoKG          , ITM_FIRtoKG        , +0 , UT_MASS                     },
  { ITM_FPFtoKPH         , ITM_KPHtoFPF         , ITM_KMHtoMPS       , +0 , UT_SPEED                    },
  { ITM_KPHtoFPF         , ITM_FPFtoKPH         , ITM_FPFtoMPS       , +0 , UT_SPEED                    },
  { ITM_BRDStoIN         , ITM_INtoBRDS         , ITM_INCHtoCM       , -2 , UT_DISTANCE                 },
  { ITM_INtoBRDS         , ITM_BRDStoIN         , ITM_BRDStoM        , +0 , UT_DISTANCE                 },
  { ITM_FIRtoLB          , ITM_LBtoFIR          , ITM_LBStoKG        , +0 , UT_MASS                     },
  { ITM_LBtoFIR          , ITM_FIRtoLB          , ITM_FIRtoKG        , +0 , UT_MASS                     },
  { ITM_FPFtoMPH         , ITM_MPHtoFPF         , ITM_MPHtoMPS       , +0 , UT_SPEED                    },
  { ITM_MPHtoFPF         , ITM_FPFtoMPH         , ITM_FPFtoMPS       , +0 , UT_SPEED                    },
  { ITM_FPStoKMH         , ITM_KMHtoFPS         , ITM_KMHtoMPS       , +0 , UT_SPEED                    },
  ...
  { ITM_INCHtoBANANA     , ITM_BANANAtoINCH     , ITM_BANANAtoMM     , -3 , UT_DISTANCE                 },
  { ITM_BANANAtoMM       , ITM_MMtoBANANA       , ITM_NULL           , -3 , UT_DISTANCE                 },
  { ITM_MMtoBANANA       , ITM_BANANAtoMM       , ITM_BANANAtoMM     , -3 , UT_DISTANCE                 },
  { ITM_ERGtoJ           , ITM_JtoERG           , ITM_NULL           , +0 , UT_ENERGY                   },
  { ITM_JtoERG           , ITM_ERGtoJ           , ITM_ERGtoJ         , +0 , UT_ENERGY                   },
  { ITM_FoetoJ           , ITM_JtoFoe           , ITM_NULL           , +0 , UT_ENERGY                   },
  { ITM_JtoFoe           , ITM_FoetoJ           , ITM_FoetoJ         , +0 , UT_ENERGY                   },
  { ITM_CtoK             , ITM_KtoC             , ITM_NULL           , +0 , UT_TEMPERATURE              },
  { ITM_KtoC             , ITM_CtoK             , ITM_CtoK           , +0 , UT_TEMPERATURE              },
  { ITM_RAtoK            , ITM_KtoRA            , ITM_NULL           , +0 , UT_TEMPERATURE              },
  { ITM_KtoRA            , ITM_RAtoK            , ITM_RAtoK          , +0 , UT_TEMPERATURE              },
  { ITM_RAtoF            , ITM_FtoRA            , ITM_FtoK           , +0 , UT_TEMPERATURE              },
  { ITM_FtoRA            , ITM_RAtoF            , ITM_RAtoK          , +0 , UT_TEMPERATURE              },
  { ITM_EVKBtoK          , ITM_KtoEVKB          , ITM_NULL           , +0 , UT_TEMPERATURE              },
  { ITM_KtoEVKB          , ITM_EVKBtoK          , ITM_EVKBtoK        , +0 , UT_TEMPERATURE              },
  { ITM_FtoK             , ITM_KtoF             , ITM_NULL           , +0 , UT_TEMPERATURE              },
  { ITM_KtoF             , ITM_FtoK             , ITM_FtoK           , +0 , UT_TEMPERATURE              },
  { ITM_KNOTtoMPS        , ITM_MPStoKNOT        , ITM_NULL           , +0 , UT_SPEED                    },
  { ITM_MPStoKNOT        , ITM_KNOTtoMPS        , ITM_KNOTtoMPS      , +0 , UT_SPEED                    },
  { ITM_DEGPStoRADPS     , ITM_RADPStoDEGPS     , ITM_NULL           , +0 , UT_ANGULAR_SPEED            },
  { ITM_RADPStoDEGPS     , ITM_DEGPStoRADPS     , ITM_DEGPStoRADPS   , +0 , UT_ANGULAR_SPEED            },
  { ITM_SLUGtoKG         , ITM_KGtoSLUG         , ITM_NULL           , +0 , UT_MASS                     },
  { ITM_KGtoSLUG         , ITM_SLUGtoKG         , ITM_SLUGtoKG       , +0 , UT_MASS                     },
  { ITM_SLINCHtoKG       , ITM_KGtoSLINCH       , ITM_NULL           , +0 , UT_MASS                     },
  { ITM_KGtoSLINCH       , ITM_SLINCHtoKG       , ITM_SLINCHtoKG     , +0 , UT_MASS                     },
  { ITM_BLOBtoKG         , ITM_KGtoBLOB         , ITM_NULL           , +0 , UT_MASS                     },
  { ITM_KGtoBLOB         , ITM_BLOBtoKG         , ITM_BLOBtoKG       , +0 , UT_MASS                     },
  { ITM_TONNEtoKG        , ITM_KGtoTONNE        , ITM_NULL           , +0 , UT_MASS                     },
  { ITM_KGtoTONNE        , ITM_TONNEtoKG        , ITM_TONNEtoKG      , +0 , UT_MASS                     },
  { ITM_LBSFT2toPA       , ITM_PAtoLBSFT2       , ITM_NULL           , +0 , UT_PRESSURE                 },
  { ITM_PAtoLBSFT2       , ITM_LBSFT2toPA       , ITM_LBSFT2toPA     , +0 , UT_PRESSURE                 },
  { ITM_INLBStoNM        , ITM_NMtoINLBS        , ITM_NULL           , +0 , UT_TORQUE                   },
  { ITM_NMtoINLBS        , ITM_INLBStoNM        , ITM_INLBStoNM      , +0 , UT_TORQUE                   },
  { ITM_LBSFTtoNPM       , ITM_NPMtoLBSFT       , ITM_NULL           , +0 , UT_NOT_CONFIGURABLE         },  // future: UT_LINEAR_FORCE_DENSITY
  { ITM_NPMtoLBSFT       , ITM_LBSFTtoNPM       , ITM_NULL           , +0 , UT_NOT_CONFIGURABLE         },  // future: UT_LINEAR_FORCE_DENSITY
  { ITM_KGFtoN           , ITM_NtoKGF           , ITM_NULL           , +0 , UT_FORCE                    },
  { ITM_NtoKGF           , ITM_KGFtoN           , ITM_KGFtoN         , +0 , UT_FORCE                    },
  { ITM_MS2toFTS2        , ITM_FTS2toMS2        , ITM_FTS2toMS2      , +0 , UT_ACCELERATION             },
  { ITM_FTS2toMS2        , ITM_MS2toFTS2        , ITM_NULL           , +0 , UT_ACCELERATION             },
  { ITM_MS2toINS2        , ITM_INS2toMS2        , ITM_INS2toMS2      , +0 , UT_ACCELERATION             },
  { ITM_INS2toMS2        , ITM_MS2toINS2        , ITM_NULL           , +0 , UT_ACCELERATION             },
  { ITM_KSItoMPA         , ITM_MPAtoKSI         , ITM_NULL           , +6 , UT_PRESSURE                 },  // MPa = 10^6 Pa
  { ITM_MPAtoKSI         , ITM_KSItoMPA         , ITM_KSItoMPA       , +6 , UT_PRESSURE                 },
  { ITM_LBSIN3toBLOBIN3  , ITM_BLOBIN3toLBSIN3  , ITM_BLOBIN3toKGM3  , +0 , UT_DENSITY                  },
  { ITM_BLOBIN3toLBSIN3  , ITM_LBSIN3toBLOBIN3  , ITM_LBSIN3toKGM3   , +0 , UT_DENSITY                  },
  { ITM_LBSIN3toTMM3     , ITM_TMM3toLBSIN3     , ITM_TMM3toKGM3     , +0 , UT_DENSITY                  },
  { ITM_TMM3toLBSIN3     , ITM_LBSIN3toTMM3     , ITM_LBSIN3toKGM3   , +0 , UT_DENSITY                  },
  { ITM_LBSIN3toKGM3     , ITM_KGM3toLBSIN3     , ITM_NULL           , +0 , UT_DENSITY                  },
  { ITM_KGM3toLBSIN3     , ITM_LBSIN3toKGM3     , ITM_LBSIN3toKGM3   , +0 , UT_DENSITY                  },
  { ITM_KGM3toBLOBIN3    , ITM_BLOBIN3toKGM3    , ITM_BLOBIN3toKGM3  , +0 , UT_DENSITY                  },
  { ITM_BLOBIN3toKGM3    , ITM_KGM3toBLOBIN3    , ITM_NULL           , +0 , UT_DENSITY                  },
  { ITM_KGM3toTMM3       , ITM_TMM3toKGM3       , ITM_TMM3toKGM3     , +0 , UT_DENSITY                  },
  { ITM_TMM3toKGM3       , ITM_KGM3toTMM3       , ITM_NULL           , +0 , UT_DENSITY                  },
  { ITM_LBSFTtoKGM       , ITM_KGMtoLBSFT       , ITM_NULL           , +0 , UT_NOT_CONFIGURABLE         },  // future: UT_LINEAR_MASS_DENSITY
  { ITM_KGMtoLBSFT       , ITM_LBSFTtoKGM       , ITM_NULL           , +0 , UT_NOT_CONFIGURABLE         },  // future: UT_LINEAR_MASS_DENSITY
  { ITM_IN3toMM3         , ITM_MM3toIN3         , ITM_NULL           , -6 , UT_VOLUME                   },  // mm^3 = 10^-6 L
  { ITM_MM3toIN3         , ITM_IN3toMM3         , ITM_IN3toMM3       , -6 , UT_VOLUME                   },
  { ITM_IN2toMM2         , ITM_MM2toIN2         , ITM_NULL           , -6 , UT_AREA                     },  // mm^2 = 10^-6 m^2
  { ITM_MM2toIN2         , ITM_IN2toMM2         , ITM_IN2toMM2       , -6 , UT_AREA                     },
  { ITM_IN4toMM4         , ITM_MM4toIN4         , ITM_NULL           , +0 , UT_NOT_CONFIGURABLE         },  // future: UT_SECOND_MOMENT_OF_AREA
  { ITM_MM4toIN4         , ITM_IN4toMM4         , ITM_NULL           , +0 , UT_NOT_CONFIGURABLE         },  // future: UT_SECOND_MOMENT_OF_AREA
  { ITM_IN6toMM6         , ITM_MM6toIN6         , ITM_NULL           , +0 , UT_NOT_CONFIGURABLE         },  // future: UT_WARPING_CONSTANT
  { ITM_MM6toIN6         , ITM_IN6toMM6         , ITM_NULL           , +0 , UT_NOT_CONFIGURABLE         },  // future: UT_WARPING_CONSTANT
};
