...
TO_QSPI static const real_t * const conversionFactors[constFactorEND] = {
    ...
    [constFactorInchM]        = const_InchToM,
    ...
    [constFactorFurtom]       = const_furToM,       /*  70 */
    ...
    [constFactorFpstomps]     = const_fpsToMps,     /*  80 */
    ...
    [constFactorCupcFzus]     = const_CupcFzus,     /*  90 */
    ...
    [constFactorMlCupc]       = const_CupcMl,       /* 100 */
    ...
    [constFactorPintlqMl]     = const_PintlqMl,     /* 110 */
    ...
    [constFactorTspukFzuk]    = const_FzukTspuk,    /* 120 */
    [constFactorTspukMl]      = const39_TspukMl,
    ...
    [constFactorGlukFzuk]     = const_GlukFzuk,     /* 130 */
    ...
    [constFactorErgJ]         = const_ErgToJ,       /* 140 */
    ...
    [constFactorLbsftNpm]     = const39_SlugToKg,   /* 150 */
    ...
    [constFactorIn2Mm2]       = const_In2ToMm2,     /* 160 */
    [constFactorIn4Mm4]       = const_In4ToMm4,
    [constFactorIn6Mm6]       = const_In6ToMm6,     /* 162 */
  };
