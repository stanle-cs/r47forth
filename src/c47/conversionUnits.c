...
// TODO: add ITM_KNOTtoMPS and ITM_DEGPStoRADPS
//       so that ITM_KMHtoKNOT (2085) and ITM_RPMtoDEGPS (2088) can be reclassified from 
//       UT_NOT_CONFIGURABLE to UT_SPEED and UT_ANGULAR_SPEED respectively, completing the SI-config coverage.
...
TO_QSPI static const convPair_t convertPairs[NUM_CONVERT_PAIRS] = {              // sorted by item
  ...
  { ITM_KMHtoKNOT    , ITM_KNOTtoKMH    , ITM_NULL       , +0 , UT_NOT_CONFIGURABLE },
  { ITM_KMHtoMPS     , ITM_MPStoKMH     , ITM_NULL       , +0 , UT_SPEED            },
  { ITM_MPStoKMH     , ITM_KMHtoMPS     , ITM_KMHtoMPS   , +0 , UT_SPEED            },
  { ITM_RPMtoDEGPS   , ITM_DEGPStoRPM   , ITM_NULL       , +0 , UT_NOT_CONFIGURABLE },
