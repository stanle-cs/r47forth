...
//Solver
        ...
        else if((currentSolverStatus & SOLVER_STATUS_USES_FORMULA) && (currentSolverStatus & SOLVER_STATUS_INTERACTIVE) && (currentDynamicSoftmenu() == NULL || *getNthString(currentDynamicSoftmenu()->menuContent, dynamicMenuItem) == 0)) {
          item = ITM_NOP;
        }
