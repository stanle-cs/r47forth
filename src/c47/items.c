...
/* 1527 */  { fnGetMatrixDimensions,           REGISTER_X,                  "M.DIM#",                                      "DIM#",                                        (0 << TAM_MAX_BITS) |     0, CAT_FNCT | SLS_ENABLED   | US_ENABLED   | EIM_DISABLED | PTP_NONE         | HG_ENABLED         | RESULT_IN_X },
...
/* 2738 */  { itemToBeCoded,                NOPARAM,                     "",                                               "Last item",                                   (0 << TAM_MAX_BITS) |     0, CAT_NONE | SLS_ENABLED   | US_UNCHANGED | EIM_DISABLED | PTP_DISABLED     | HG_ENABLED         },
