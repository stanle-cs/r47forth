...
#define X_TIME                                      1 // note: this is used only if DATE is not displayed, otherwise TIME is printed directly next to date's end
#define X_REAL_COMPLEX                            136 // absolute anchor (= old 45+91); note: this is for both dow or time, not both
...
#define NUMBER_OF_GLYPH_ROWS                     267 //Used in the font browser application
