...
TO_QSPI const int16_t menu_PFN_2[]       = { ITM_KEYG,                  ITM_KEYX,                  ITM_MENU,                  ITM_MVAR,                  ITM_VARMNU,                -MNU_PFN_3,
                                             ...
                                             ITM_R_COPY,                ITM_R_SORT,                ITM_R_SWAP,                ITM_R_CLR,                 -MNU_CANVAS,               ITM_NULL                       };
...
TO_QSPI const int16_t menu_CANVAS[]      = { ITM_PVIEW,                 ITM_ERASE,                 ITM_NULL,                  ITM_NULL,                  ITM_NULL,                  ITM_NULL            };
...
/* 180b*/  {.menuItem = -MNU_CANVAS,        .numItems = sizeof(menu_CANVAS        )/sizeof(int16_t), .softkeyItem = menu_CANVAS         },       // program-graphics package: four rows above the tail, clear of pretty-print-extra's tail row
