...
int forthDictSelfTest(void)
{
  ...
  printf("  [DEBUG] running test_console_output_glyph_integrity...\n");
  fail |= test_console_output_glyph_integrity();
  printf("  [DEBUG] running test_console_line_survives_gestures...\n");
  ...
  printf("\nFORTH AUDIT ROUND 8 TESTS (the round-7 fix wave's findings, driven)\n");
  printf("  [DEBUG] running test_fold_round8_window...\n");
  fail |= test_fold_round8_window();
