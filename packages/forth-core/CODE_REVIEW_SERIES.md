...
**Read:** `packages/forth-core/DESIGN.md` whole (~42K). Then, per citation, a
...
`custom_package/PROPOSED_SPEC_CHANGES.md`. Budget ~40K.
...
**Output.** `QWEN_PROMPTS_R5_tooling.md`. Note: tooling lives in `tools/`, not
